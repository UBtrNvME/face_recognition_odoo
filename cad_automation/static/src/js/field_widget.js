odoo.define('cad_automation.ConnectionFieldView', function (require) {
    ...
    class FieldConnection extends AbstracFieldOwl {
        ...
        get isSet() {
            return !!(this.value !== "" && Array.isArray(JSON.parse(this.value)))
        }
        ...
        addConnection() {
            let lastConnections = this.connections[this.connections.length - 1]
            if (
                !(lastConnections.pos.x === "" && lastConnections.pos.y === ""
                    && lastConnections.dir.x === "" && lastConnections.dir.y === "")
            ) {
        ...
        saveConnections () {
            let connections = this._parseConnections()
